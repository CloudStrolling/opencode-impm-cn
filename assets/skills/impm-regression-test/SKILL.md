...
2. 收集本版本测试用例：读取当前版本测试用例 docs/{项目英文缩写}-v{当前版本号}/{项目英文缩写}-testcase-v{当前版本号}.md（以及步骤 1 合并后的主测试用例 docs/{项目英文缩写}-testcase.md），提取所有测试用例编号（TC-xxx）及其"关联需求ID"（FR-xxx / US-xxx；需求/用户故事编号项目全局唯一，形如 FR-v0.0.1-001、US-v0.0.1-001）。
