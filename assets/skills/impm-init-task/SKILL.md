...
1. docs/{项目英文缩写}-v0.0.1/{项目英文缩写}-prd-v0.0.1.md（或主文档 docs/{项目英文缩写}-prd.md），提取用户故事编号（US-xxx，编号项目全局唯一，如 US-v0.0.1-001）及其故事描述；
...
字段映射规则：
- userStoryId：填写该任务实现的 PRD 用户故事编号（如 US-v0.0.1-001，编号项目全局唯一，含版本号），从步骤 2 读取的 PRD 中获取；
