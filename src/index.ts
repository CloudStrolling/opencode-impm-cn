            ...
            impm_doc_reader: {
                ...
                args: {
                    ...
                    docType: createStringSchema(
                        "文档类型：project | sad | urs | prd | dbd | api | lld | testcase | task | sql | review | context | cs | ws | ui-test-record | regression-unit | regression-api | rtm | apifox-openapi | apifox-postman | openapi | swagger | readme | agent | deploy-build | deploy-deploy",
                    ),
