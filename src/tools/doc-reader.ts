...
export const docReaderDefinition = {
    description:
        "读取项目管理文档：按标准路径读取 docs 下的文档（project、sad、urs、prd、dbd、api、lld、testcase、task、sql、review、context、cs、ws、ui-test-record、regression-unit、regression-api、regression、rtm、apifox-openapi、apifox-postman、openapi、swagger 等）。读取任务清单（task）时返回任务摘要与完整内容。",
};
